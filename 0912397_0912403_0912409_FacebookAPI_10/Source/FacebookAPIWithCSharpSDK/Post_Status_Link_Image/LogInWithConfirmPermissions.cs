...
namespace LogIn
{
    public partial class LogInWithConfirmPermissions : Form
    {
        ...
        public LogInWithConfirmPermissions()
        {
            InitializeComponent();
        }
        ...
        {
            webFacebook.Navigate(@"https://www.facebook.com/dialog/oauth?client_id=340494446046415&redirect_uri=https://www.facebook.com/connect/login_success.html&response_type=token&scope=status_update&scope=photo_upload");
        }
